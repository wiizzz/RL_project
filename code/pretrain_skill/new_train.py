...
def solve_env(env_args, agent_args, n_envs, timesteps, callbacks, eval_freq=None, init_func=None):
    ...
    if eval_freq is not None:
        ...
        callbacks.append(EvalCallback(
            ...
            n_eval_episodes=10, 
            eval_freq=eval_freq, 
            log_path=f'logs/evaluations/{env_args["scenario"]}/ammo',
            best_model_save_path=f'logs/models/{env_args["scenario"]}/ammo'))
...
agent = solve_env(env_args, agent_args, n_envs=2, timesteps=700000, callbacks=[], eval_freq=4096,init_func = init_model)
