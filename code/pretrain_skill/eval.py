...
def make_gif(agent, file_path):
        def frame_processor(frame):
            ...
            return new_frame
        env = create_vec_env(scenario = 'D3_battle',frame_processor=frame_processor)
        ...
        env.close()
model = PPO.load('./logs/models/D3_battle/best_model', custom_objects={'policy_kwargs': {'features_extractor_class':CustomCombinedExtractor}})
make_gif(model,'figure/multi1.gif')
